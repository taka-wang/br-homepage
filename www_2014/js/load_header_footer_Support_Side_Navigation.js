var load_header_footer_Side_Navigation = function() {
    ...
    function Set_Side_Navigation(json_data) {   
        ...
        var main_item       = json_data.Support[(language_type == "English") ? "title" : "tw_title"];
        var main_item_link  = json_arr.Support.link;            
        var sub_item        = [];

        $.each(json_arr.Support.data, function (index, obj) {
    ...
    //get the  pre-compile Handlebars templates(js/templates/Side_Navigation_template.js)
        var html = Handlebars.templates['main_page_Navigation_template'](parse_Side_Navigation_data);   
    ...
    function Set_header() {
        ...
        //After pre-compile get the pre-compile Handlebars templates(js/templates/header_template.js)
            var html = Handlebars.templates['main_page_header_template'](parse_header_data);
            $('#load_header').append(html);
    ...
    function Set_footer() {
        ...
        var html = Handlebars.templates['main_page_footer_template'](parse_footer_data); 

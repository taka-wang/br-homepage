var load_header_footer = function() {
    ...
    initialize();  // get current Language
        ...
        $.getJSON('www_2014/web_info.json', function(JsonData) {
    ...
    function Set_header() {
        ...
        //After pre-compile get the pre-compile Handlebars templates(js/templates/header_template.js)
            var html = Handlebars.templates['index_header_template'](parse_header_data);
            $('#load_header').append(html);
    ...
    function Set_footer() {
        ...
        var html = Handlebars.templates['index_footer_template'](parse_footer_data); 
